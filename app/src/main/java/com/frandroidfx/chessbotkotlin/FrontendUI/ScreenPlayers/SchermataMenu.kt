...
fun SchermataMenu(
    ...
    Column(modifier= Modifier
        ...
        Row(modifier = Modifier
            ...
            Button(onClick = {onNuovaPartita(ColoreScelto.BIANCO)}, modifier = Modifier.weight(1f).padding(4.dp)){ Text("Bianco",fontSize= 10.sp) }
            Button(onClick = {onNuovaPartita(ColoreScelto.NERO)}, modifier = Modifier.weight(1f).padding(4.dp)){ Text("Nero",fontSize= 10.sp) }
            Button(onClick = {onNuovaPartita(ColoreScelto.CASUALE)}, modifier = Modifier.weight(1f).padding(4.dp)){ Text("??",fontSize= 10.sp) }
